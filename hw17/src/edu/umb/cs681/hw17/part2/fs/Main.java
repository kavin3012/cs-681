...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println("HW17 Part 2");
        LocalDateTime date = LocalDateTime.now();
        ConcurrentLinkedQueue<File> sharedList = new ConcurrentLinkedQueue<File>();
        ...
        System.out.println("Total files collected: " + sharedList.size());
